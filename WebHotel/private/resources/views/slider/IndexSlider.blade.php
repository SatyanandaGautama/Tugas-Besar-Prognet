...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div align="right">
                    <a href="{{ URL('/slider/insert') }}" class="btn btn-dark"><b>Tambah</b></a>
                    <a href="{{ URL('/slider/cetak') }}" class="btn btn-success" target="_blank"><b>Cetak</b></a>
                    <div>&nbsp;<br /></div>
                </div>
                <div class="card">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-warning"
                                                href="{{ URL('/slider/' . $d->id . '/edit') }}"><b>Edit</b></a>
