...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header"><b>Form Edit Blog</b></div>
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <b>Data Blog</b><br />
                        <hr />
                        <form method="POST" action="{{ URL('/blog/' . $data->id) }}" class=""
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="judul_blog" class="form-control" id="input"
                                        placeholder="Judul Blog" value="{{ $data->judul_blog }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="tema_blog" class="form-control" id="input"
                                        placeholder="Tema Blog" value="{{ $data->tema_blog }}">
                                </div>
                            </div>
                            <div class="form-group row">
